...
// School-level structure follows NERDC's published curriculum portals.
// JSS1 topic mapping below is aligned to the NERDC JSS Mathematics curriculum;
// content should be reviewed by a qualified Nigerian mathematics educator before commercial launch.
export const curriculumSource={
  ...
  jssMathUrl:'https://nerdc.gov.ng/content_manager/jss/jss1-3_maths.pdf',
  seniorUrl:'https://nerdc.gov.ng/content_manager/new_senior_curriculum_home.html'
};

const foundation=['Number and Numeration','Basic Operations','Fractions, Decimals and Percentages','Ratio, Proportion and Rates','Algebraic Thinking','Geometry and Measurement','Data, Statistics and Probability','Mathematical Reasoning and Word Problems'];

export const curriculum={
 primary:{label:'Primary School',levels:{
  ...
  P4:{label:'Primary 4',topics:foundation.slice(0,7)},P5:{label:'Primary 5',topics:foundation},P6:{label:'Primary 6',topics:foundation}
 }},
 jss:{label:'Junior Secondary School',levels:{
  JSS1:{label:'JSS 1',topics:['Whole Numbers','LCM','HCF','Counting in Base 2','Conversion from Base 10 to Binary','Fractions','Addition and Subtraction','Addition and Subtraction of Fractions','Multiplication and Division of Fractions','Estimation','Approximation','Addition of Binary Numerals','Algebraic Processes','Geometry and Mensuration','Statistics and Data','Quantitative Reasoning and Word Problems']},
 ...
 sss:{label:'Senior Secondary School',levels:{
