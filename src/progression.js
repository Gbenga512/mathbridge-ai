...
export function saveProgress(progress){
 ...
 try{localStorage.setItem('mathbridge-progress',JSON.stringify(normalized));
  const userId=localStorage.getItem('mathbridge-current-user');
  if(userId)void saveCloudProgress(userId,normalized);
  return true;
 }catch{return false}
}
